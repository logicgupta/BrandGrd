...
public class ClientBestSellingProduct {
    private static ClientBestSellingProduct productRepo;
    ...
    public static ClientBestSellingProduct getProductRepo(){
        if (productRepo==null){
            productRepo=new ClientBestSellingProduct();
        }
        return productRepo;
    }
