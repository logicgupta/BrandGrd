package com.logistic.splashactivity.View.Client.AddItems;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (productName.isEmpty()){
                    ...
                    Toast.makeText(AddProductActivity.this, "Please Select Image 1 from Gallery", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
                else if (uri2==null){

                    Toast.makeText(AddProductActivity.this, "Please Enter Image 2 from Gallery", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
                else if (uri3==null){

                    Toast.makeText(AddProductActivity.this, "Please Enter Image 3 from Gallery", Toast.LENGTH_SHORT).show();

                    progressDialog.dismiss();
                }
                else if (uri4==null){
                    Toast.makeText(AddProductActivity.this, "Please Enter Image 4 from Gallery", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
                else {
                    viewModel= ViewModelProviders.of(AddProductActivity.this).get(ProductViewModel.class);

                    viewModel.addProduct(AddProductActivity.this,uri1.toString(),uri2.toString(),uri3.toString(),uri4.toString()
                            ,productName,productDescription,
                            productOriginalPrice
                            ,productDiscountPrice,productQuantity,pinCode
                            ,sellerName,qty,category);

                    viewModel.getStatus().observe(AddProductActivity.this, new Observer<Boolean>() {
                        @Override
